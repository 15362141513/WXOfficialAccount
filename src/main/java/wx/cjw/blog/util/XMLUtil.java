...
import wx.cjw.blog.entity.weixin.BaseMessage;
import wx.cjw.blog.entity.weixin.NewsMessage;
...
public abstract class XMLUtil {
    ...
    public static Map<String, String> parseXmlFromRequest(HttpServletRequest request) throws Exception {
        ...
        BaseMessage baseMessage = JSON.parseObject(JSON.toJSONString(msgMap), BaseMessage.class);
        log.info(baseMessage);
        log.info(baseMessage.getClass());
        return msgMap;
    }
